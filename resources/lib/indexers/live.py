...
def get_channels():
    ...
    for channel in live:
        channel.update({
            'sort': [control.SORT_METHOD_DATEADDED, (control.SORT_METHOD_LABEL_IGNORE_FOLDERS, '%T', '%U'), (control.SORT_METHOD_VIDEO_SORT_TITLE, '%T', '%U'), (control.SORT_METHOD_STUDIO, '%T', '%U')],
            'overlay': 4,
            'playcount': 0,
