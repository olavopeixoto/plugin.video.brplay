...
class Player:
    ...
    def playlive(self, id, meta):
        ...
        if encrypted:
            ...
            licence_url = u'https://proxy.claro01.verspective.net/multirights/widevine?deviceId={deviceId}'.format(deviceId=base64.urlsafe_b64encode(device_id.encode('utf-8')).decode())
